...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td width="7%"><input type="text"  class="label_purchase" value="Serial No" disabled="disabled"/></td>
    <td width="14%"><input id="txt_serino" name="txt_serino" type="text" onkeypress="keyset('TXTREFNO',event);" class="text_purchase3" /></td>
  ...
  <tr>
    ...
    <td colspan="3"><input id="txt_lastname" name="txt_lastname" type="text"  value="" class="text_purchase3" onkeypress="keyset('txtPOS_APP',event);"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td width="13%" >&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="text"  class="label_purchase" value="Finger" disabled="disabled"/></td>
    <td width="13%" >&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="31"><input type="text"  class="label_purchase" value="Place Of Issue" disabled="disabled"/></td>
    <td colspan="3"><input id="txtPLA_OF_IS" name="txtPLA_OF_IS" type="text"  value="" class="text_purchase3" onkeypress="keyset('cmbnat',event);"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td width="13%" >&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="button" style="cursor:pointer"  class="sell_search1" name="button" id="button" value="Upload Picture 1" onclick="NewWindow('upload_image.php?cou=1','mywin','700','200','yes','center');return false" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<fieldset >               
  ...
  <tr>
	<td colspan="11"><table width="1000" border="0">
                                                  ...
                                                  <td>
                                                        ...
                                                        <td>
                                                          <input type="text"  class="text_purchase3" name="txt_gccno" id="txt_gccno" size="10" onkeypress="keyset('txt_cmbno',event);" />
                                                       </td>
                                                      <td>
                                                          <input type="text"  class="label_purchase" value="C.M.B No" disabled="disabled"/>
                                                       </td>
                                                        <td>
                                                          <input type="text"  class="text_purchase3" name="txt_cmbno" id="txt_cmbno" size="10" onkeypress="keyset('txtadd',event);"  />
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td>
  ...
  <tr>
    <td colspan="7"><fieldset>   <table width="1000" border="0">
      <tr>
        <td colspan="3" align="center"><span class="style2">
          <input type="text"  class="label_purchase" value="Package" disabled="disabled"/>
        </span></td>
        <td align="center"><font color="#FFFFFF">
          <select name="cmbpackage" id="cmbpackage" class="text_purchase3" onchange="set_treatment();" >
           <option value=""></option>
          	<?php
          	include('connection.php');
			
        	$sql_rst = "select distinct package_no from package_mas order by package_no";
			$result_rst=mysql_query($sql_rst, $dbinv);
			while($row_rst = mysql_fetch_array($result_rst)){	
        		echo "<option value=".$row_rst["package_no"].">".$row_rst["package_no"]."</option>";
			}
			?>
          </select>
        </font></td>
      ...
      <tr>
        <td colspan="4">
        <div id="treat_list" style="overflow:scroll;  height:300px" >
