...
<script language="JavaScript" src="js/pur.js"></script>
...
<div class="sct_right"><!--<button type=button style="background: #555 url(images/icn_alert_warning.png) no-repeat center; padding: 0.5em 1em; color:#FFFFFF" onclick="">Save</button>-->
    ...
    <form name="form1" id="form1"> 
        ...
        <table width="100%" border="0"  class=\"form-matrix-table\">
            ...
            <tr>
                <td><input type="text"  class="label_purchase" value="Reference No" disabled/></td>
                <td colspan="2"><input type="text"  class="text_purchase3" name="invno" id="invno"/>
                    <a href="serach_arn.php?stname=inv_mast" onClick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');
                            return false" onFocus="this.blur()">
                    <input type="hidden" name="txtdono" id="txtdono" />
                    </a></td>
                <td><a href="serach_arn.php?stname=inv_mast" onclick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');
                            return false" onfocus="this.blur()">
                ...
                <tr>
                    <td><font color="#FFFFFF">
                        <div id="test"><font color="#FFFFFF">
                            <input type="text"  class="text_purchase3" name="itemd_hidden" id="itemd_hidden" onblur='itno_ind();' size="10" onkeypress="keyset('qty', event);"    />
                            </font></div>  </font></td>
