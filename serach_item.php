            ...
            <tr>
                ...
                <td  background="images/headingbg.gif" >
                    ...
                    if ($_GET["stname"] == "ord_item") {
                        echo "<input type=\"checkbox\" name=\"checkbox\" id=\"checkbox\" onclick=\"update_list();\" />";
                    } else {
                        echo "<input type=\"checkbox\" name=\"checkbox\" id=\"checkbox\" onclick=\"update_list();\" />";
                    }
                    ?>	
                ...
                <tr>
                    <?php
                    if ($_GET["stname"] == "") {
                        echo "<td width=\"122\"  background=\"images/headingbg.gif\" ><input type=\"text\" size=\"20\" name=\"itno\" id=\"itno\" value=\"\" class=\"txtbox\" onkeyup=\"update_list();\"/></td>
      <td width=\"603\"  background=\"images/headingbg.gif\" ><input type=\"text\" size=\"70\" name=\"itemname\" id=\"itemname\" value=\"\" class=\"txtbox\" onkeyup=\"update_list();\"/></td>";
                    } else {
                        echo "<td width=\"122\"  background=\"images/headingbg.gif\" ><input type=\"text\" size=\"20\" name=\"itno\" id=\"itno\" value=\"\" class=\"txtbox\" onkeyup=\"update_list();\"/></td>
      <td width=\"603\"  background=\"images/headingbg.gif\" ><input type=\"text\" size=\"70\" name=\"itemname\" id=\"itemname\" value=\"\" class=\"txtbox\" onkeyup=\"update_list();\"/></td>";
                    }
                    ...
                    <div id="filt_table" class="CSSTableGenerator">  <table width="735" border="0" class=\"form-matrix-table\">
                            ...
                            $db = new DBConnector();
                                ...
                                while ($row = mysql_fetch_array($result)) {
                                    ...
                                    echo "<tr>               
                              <td onclick=\"itno_undeliver('" . $row['STK_NO'] . "');\">" . $row['STK_NO'] . "</a></td>
                              <td onclick=\"itno_undeliver('" . $row['STK_NO'] . "');\">" . $row['DESCRIPT'] . "</a></td>
			      <td onclick=\"itno_undeliver('" . $row['STK_NO'] . "');\">" . $row['QTYINHAND'] . "</a></td>";
