...
<script language="JavaScript" src="js/medical_entry.js"></script>
...
<tr>					
      ...
      <td width="603"  background="" ><input type="text" size="29" name="invdate" id="invdate" value="" class="txtbox"/></td>
                ...
                <div class="CSSTableGenerator" id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
                            <tr>
                              <td width="100"  background="" ><font color="#FFFFFF">PP No</font></td>
                              <td width="100"  background=""><font color="#FFFFFF">PA No</font></td>
                              <td width="100"  background=""><font color="#FFFFFF">CMB No</font></td>
							...
							echo "<tr>               
                              <td onclick=\"assn_med_entry('".$row['DREFNO']."');\">".$row['DREFNO']."</a></td>
							  <td onclick=\"assn_med_entry('".$row['DREFNO']."');\">".$row['PA_NO']."</a></td>
							  <td onclick=\"assn_med_entry('".$row['DREFNO']."');\">".$row['CMB_NO']."</a></td>
							  <td onclick=\"assn_med_entry('".$row['DREFNO']."');\">".$row['NAME']."</a></td>
							  <td onclick=\"assn_med_entry('".$row['DREFNO']."');\">".$row['SDATE']."</a></td>";
