...
<form name="form1" id="form1">            
        <table width="92%" border="0"  class=\"form-matrix-table\">
            <tr>
                ...
                <td width="6%"><input type="text" name="refno" id="refno" value="" class="text_purchase3" onkeypress="keyset('searchcust', event);"  />
                    <a href="search_pareg.php?stname=his" onClick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');
                            return false" onFocus="this.blur()"></a>                </td>
                <td width="6%"><a href="search_pareg.php?stname=his" onclick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');
            ...
            <td width="12%"><input type="text"  class="label_purchase" value="Entry date" disabled/></td>
            <td width="12%"><input type="text" name="entdate" id="entdate" value="" class="text_purchase3" onkeypress="keyset('searchcust', event);"  /></td>
            <td width="52%" colspan="5">            </td>
            </tr>
