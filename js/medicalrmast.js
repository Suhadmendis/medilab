...
function med_mast_ass(TCODE, TDESCRIPT, TAMOUNT)
{
	
    document.getElementById('code').value=TCODE;	
	document.getElementById('name').value=TDESCRIPT;	
	document.getElementById('down_pay').value=TAMOUNT;	
}
...
function save_inv()
{
    ...
    if (document.getElementById('code').value != "") {
        ...
        url = url + "&down_pay=" + document.getElementById('down_pay').value;
...
function new_inv()
{
    ...
    document.getElementById('down_pay').value = "";
