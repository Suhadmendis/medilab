...
$_SESSION["page_name2"]="OPD Summery";
...
<div class="sct_right"><!--<button type=button style="background: #555 url(images/icn_alert_warning.png) no-repeat center; padding: 0.5em 1em; color:#FFFFFF" onclick="">Save</button>-->
    ...
    <form id="form1" name="form1" action="report_sales_summery.php" target="_blank" method="get">
        <table border="0">
            ...
            <tr>  
                <td colspan="2"><input type="radio" name="type" value="detail" id="detail" checked />Detail</td>
                <td colspan="2"><select name="typed" id="typed" class="text_purchase3" >
                        <option value='dswise'>Amount</option>
                        <option value='ddwise'>Detail</option>
                   </select></td>
                  
            </tr>
            <tr>  
                <td colspan="2"><input type="radio" name="type" value="summery" id="summery" />Summery
                </td>
                 <td colspan="2"><select name="typeg" id="typeg" class="text_purchase3" >
                        <option value='date'>Date</option>
                        <option value='twise'>Test Wise</option>
                        <option value='dwise'>Doctor Wise</option>
            ...
            <tr>
                ...
                <td width="200">To<input type="text" size="10" value="<?php echo date('Y-m-d'); ?>" name="dte_to"  onfocus="load_calader('dte_to');"   id="dte_to" value="" class="text_purchase3"/>
                </td>
            </tr>
