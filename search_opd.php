...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="textt" name="textt">
            <p>OPD List On <?php echo date("Y-m-d"); ?></p>
        </div>
        ...
        <div class="CSSTableGenerator" id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
                ...
                $sdate = date('Y-m-d');
                $sql = "SELECT * FROM pa_app  where sdate = '" . $sdate . "' order by serino desc  ";
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<td onclick=\"arnno_gin('" . $row['refno'] . "');\">" . $row['totalamount'] . "</a></td>
