...
<div class="sct_right"><!--<button type=button style="background: #555 url(images/icn_alert_warning.png) no-repeat center; padding: 0.5em 1em; color:#FFFFFF" onclick="">Save</button>-->
    ...
    <form id="form1" name="form1" action="report_channel_summery.php" target="_blank" method="get">
        <table border="0">

            <tr>  
                <td colspan="2"><input type="radio" name="type" checked value="detail" id="detail" />Detail</td>
                <td colspan="2">
